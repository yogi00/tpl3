...
public abstract class SocialChannelBuilderTest {
	...
	@Test @Ignore
	public void testCreateGooglePlusChannel() {
		SocialChannelBuilder builder = createSocialChannelBuilderUnderTest();

		// ChannelProperties.
		SocialChannelProperties props = new SocialChannelProperties();

		SocialChannel channel = builder.buildChannel(props.putProperty(SocialChannelPropertyKey.NAME, GooglePlusChannel.NAME));
		assertNotNull(channel);
		assertTrue(channel instanceof GooglePlusChannel);
